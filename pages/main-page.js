...
export default function MainPage() {
    ...
    return (
        <Layout title="Main page">
            ...
            {/* クリックされたときにlogout関数が呼ばれるようにする */}
            <svg onClick={logout} className="mt-10 cursor-pointer w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
